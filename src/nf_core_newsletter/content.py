...
def fetch_email_html(edition: Edition) -> str:
    ...
    The email page carries the ``{{amazonSESUnsubscribeUrl}}`` placeholder in its
    footer (rendered by the website); SES replaces it with the hosted unsubscribe
    URL when the email is sent with ListManagementOptions.
    """
